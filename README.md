<p align="center">
  <a href="https://consumet.org/">
    <img alt="FluxiumLab" src="https://consumet.org/images/consumetlogo.png" width="150">
  </a>
</p>
...
<p align="center">
  FluxiumLab provides APIs for accessing information and links for various entertainment sources like movies, books, anime, and more.
</p>
<p align="center">
...
FluxiumLab scrapes data from various websites and provides APIs for accessing the data to satisfy your needs.

> [!IMPORTANT]
> Self-hosting FluxiumLab is required to use the API. FluxiumLab API is no longer publicly available. Please refer to the [Installation section](#installation) for more information on hosting your own instance.

> [!CAUTION]
> FluxiumLab is not affiliated with any of the providers it scrapes data from. FluxiumLab is not responsible for any misuse of the data provided by the API. Commercial utilization may lead to serious consequences, including potential site takedown measures. Ensure that you understand the legal implications before using this API.
...
### Heroku
Host your own instance of FluxiumLab API on Heroku using the button below.
...
### Vercel
Host your own instance of FluxiumLab API on Vercel using the button below.
...
### Render
Host your own instance of FluxiumLab API on Render using the button below.
...
### Railway
Host your own instance of FluxiumLab API on Railway using the button below.
