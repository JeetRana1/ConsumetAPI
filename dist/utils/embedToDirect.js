...
const tryExtractor = async (provider, embedUrl, requestedServer) => {
    ...
    for (const server of serverOrder) {
        ...
        const extractors = isMixDrop
            ? [extractors_1.MixDrop, extractors_1.StreamTape, extractors_1.VidCloud, extractors_1.MegaCloud]
            : isMp4Upload
                ? [extractors_1.MixDrop, extractors_1.StreamTape, extractors_1.VidCloud, extractors_1.MegaCloud]
                : isStreamTape
                    ? [extractors_1.StreamTape, extractors_1.MixDrop, extractors_1.VidCloud, extractors_1.MegaCloud]
                    : isVizCloud
                        ? [extractors_1.VidCloud, extractors_1.MegaCloud, extractors_1.VideoStr]
                        : isVideoStr
                            ? [extractors_1.VideoStr, extractors_1.MegaCloud, extractors_1.VidCloud]
                            : server === models_1.StreamingServers.MegaCloud
                                ? [extractors_1.MegaCloud, extractors_1.VidCloud, extractors_1.VideoStr]
